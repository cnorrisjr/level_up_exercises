...
describe Bomb do
  ...
  context 'When entering valid codes' do
    ...
    it 'With a user submitted Activation Code & the default deactivate code' do
    ...
    it 'With a user submitted deactivation code & default activate code' do
  ...
  context "Verify that a bomb can be activationed" do
  ...
  context "Verify that a bomb can be deactivationed" do
    it 'Using the correct default deactivation code' do
      my_bomb = Bomb.new
      my_bomb.activate('1234')
      expect(my_bomb.status).to eql(:active)
    ...
    it 'Using the wrong deactivation code' do
      my_bomb = Bomb.new
      my_bomb.activate('1234')
      expect(my_bomb.status).to eql(:active)
    ...
    it 'Using the correct custom deactivation code ' do
    ...
    it 'Using the wrong custom code deactivation code' do
      my_bomb = Bomb.new(deactivate_code: '6789')
      my_bomb.activate('1234')
      expect(my_bomb.status).to eql(:active)
